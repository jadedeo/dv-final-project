...
<script>
    ...
    const getDotStyle = (index) => {
      return (index <= hoverIndex) && locked ? '#E54F6D' : (index <= hoverIndex) && !locked ? "#faae20" : "gray";
    };
    ...
    <div class="header-and-paragraphs">
        ...
        <p>
            Vivamus ut ex vitae mi iaculis vulputate. Morbi maximus ac nulla non placerat. Aliquam erat volutpat.
            Cras molestie, purus elementum tempus mattis, arcu nunc placerat risus, vitae accumsan tellus purus nec justo.
        </p>
    </div>

    <div>
        <p>The sex ratio in most communities hovers somewhere around 50:50.</p>
        <h4>What do you think the male to female ratio among indentured laborers in plantation colonies was?</h4>
    </div>
